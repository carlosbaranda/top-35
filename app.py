...
# --- Selección de número de valores para Top Ganancia y Caída ---
st.subheader("🏁 Número de valores en tablas Top")
top_n = st.slider("Selecciona cuántos mostrar en Top Ganancia y Top Caída (por mercado):", min_value=5, max_value=35, value=20)
